...
\section{Navržené změny}
    \subsection{Interní DSL}
        % TODO popsat podroneji
        Interní DSL jazyk poskytuje možnost vytvořit pravidlo opakovaní. Dále uvádím příklad \textit{Intervalu}, který má pravidlo opakování vytvořené pomoci DSL jazyku. Tento interval bude použit při testování.
        \begin{figure}
            \begin{minted}{java}
/**
...
private val validInterval = Interval(
    ...
    \subsection{Implementace Service layer}%prejmenovat na ceskou verzi
...
\section{Návrh bezpečnosti}\label{navrh:bezpecnost}
    ...
    \subsection{HTTPS}
        certificaty TODO
\section{Databáze}
    TODOdatabaze pro profil production
\section{Profily}\label{navrh:profily}
    TODO nové profily a jejích konfigurace
\section{Implementace historických záznamů}
    TODO history + seznam trid kterych se tykaji zmeny
\section{Implementace požadávků na změny}
    TODO requests
