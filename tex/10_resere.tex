...
\section{Databáze}\label{resere:databaze}
    ...
    \subsection{H2}
        TODO Pro proces vývoje a testování byla zvolena databáze H2\cite{ht-download}, která je relační databází. 
...
\section{CLOC}\label{resere:cloc}
    Nástroj CLOC\footnote{Count Lines of Code} poskytuje možnost spočítat počet řádek kódu v dáne složce. Nástroj podporuje velký počet jazyku programování. Výsledek obsahuje počet řádek kódu oddělený od komentářů a prázdných řádků.