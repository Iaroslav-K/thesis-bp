...
\supervisor{Ing. Jiří Hunka}
\acknowledgements{\input{latex_templates_20191223/tex/acknoledgement}}
\abstractCS{\input{latex_templates_20191223/tex/abstract_cs}}
% \abstractCS{V~několika větách shrňte obsah a přínos této práce v~češtině. Po přečtení abstraktu by se čtenář měl mít čtenář dost informací pro rozhodnutí, zda chce Vaši práci číst.}
\abstractEN{\input{latex_templates_20191223/tex/abstract_en}}
